    ...
    return (
       <>
        <div className="container">
            <div className="row">
                <div id="sharedMenudivs" className="col-lg-5 col-xs-12">
                    <h4 className="borderbottom">Show  all *</h4>
                ...
                <div id="sharedMenudivs" className="col-lg-5 col-xs-12"><h4 className="borderbottom">Search by id</h4>
                ...
                <div id="sharedMenudivs" className="col-lg-5 col-xs-12"><h4 className="borderbottom">Search by title/name</h4>
                    <p>Search by title/name is an application developed to show you the items based on the title 
                    from the database. Enter the application with the link in the navbar.</p>
                </div>
       
                <div id="sharedMenudivs" className="col-lg-5 col-xs-12"><h4 className="borderbottom">Add new *</h4>
                    <p>Add new * is an application developed to let you add new objects to the database.
                    Enter the application with the link in the navbar.</p>
                </div>
            
                <div id="sharedMenudivs" className="col-lg-5 col-xs-12"><h4 className="borderbottom">Update *</h4>
                ...
                <div id="sharedMenudivs" className="col-lg-5 col-xs-12"><h4 className="borderbottom">Delete *</h4>
